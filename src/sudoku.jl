...
include("CellBag.jl")
export CellBag, filled_cells, empty_cells, iscompleted, InvalidInputException, remove_possible_values!, compare,
...
export Box, get_cells, create_all, compare
